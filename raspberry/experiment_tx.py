...
class ExperimentTx(threading.Thread):
    ...
    def run(self):
        ...
        for fmt in freq_mod_tech:
            ...
            self.radio_driver.radio_write_config(freq_mod_tech[5][0])
            ...
            self.radio_driver.radio_set_frequency(freq_mod_tech[5][1])
            logging.info("frequencies: {0}".format(freq_mod_tech[5][1]))
