...
modulations_settings = {
    ...
    '2fsk_50kbps_FEC_200kHz': [
        ...
        (RG_RF09_TXCUTC,        0xC0),
        (RG_RF09_TXDFE,         0x98),
        (RG_RF09_PAC,           0x7F),  # // Tx Power 5 bits >>. 0x64 = txPwr=>0x04, max: 0x1F. 0x14~8 dBm
    ...
    'oqpsk_6.25kbps': [
        ...
        (RG_RF09_PAC,           0x7F)],  # Tx Power 5 bits >>. 0x64 = txPwr=>0x04, max: 0x1F. # 0x15~8 dBm
    ...
    'subGHz_ofdm_100kbps_1200kHz_mcs0': [
        ...
        (RG_RF09_TXDFE,         0x83),
        (RG_RF09_PAC,           0x7F),  # Tx Power 5 bits >>. 0x64 = txPwr=>0x04, max: 0x1F. # 0x1D~8dBm
        (RG_BBC0_IRQM,          0x12),
        (RG_BBC1_IRQM,          0x00),
    ...
    'subGHz_ofdm_50kbps_800kHz_mcs0': [
        ...
        (RG_RF09_TXDFE,         0x63),
        (RG_RF09_PAC,           0x7F),  # Tx Power 5 bits >>. 0x64 = txPwr=>0x04, max: 0x1F. # 0x1C~8dBm
        (RG_BBC0_IRQM,          0x12),
        (RG_BBC1_IRQM,          0x00),
        (RG_BBC0_PC,            0x16),  # NO FCS FILTER in RX, FCS automatically added in TX
        (RG_BBC0_OFDMC,         0x01),
    ...
    'subGHz_ofdm_50kbps_200kHz_mcs2': [
        ...
        (RG_RF09_TXDFE,         0x46),
        (RG_RF09_PAC,           0x7F),  # Tx Power 5 bits >>. 0x64 = txPwr=>0x04, max: 0x1F. # 0x1B~8dBm
        (RG_BBC0_IRQM,          0x12),
        (RG_BBC1_IRQM,          0x00),
        (RG_BBC0_PC,            0x16),  # NO FCS FILTER in RX, FCS automatically added in TX
        (RG_BBC0_OFDMC,         0x03),
