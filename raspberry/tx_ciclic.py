...
class ExperimentTx(threading.Thread):
    ...
    def run(self):
        ...
        self._execute_experiment_tx(self.settings['test_settings'][0])
...
def load_experiment_details():
    with open('/home/pi/range_test/raspberry/sniffer_settings.json', 'r') as f:
...
def main():
    ...
    while True:
        ...
        if input == 'q':
            ...
            experimentTx.radio_driver.radio_off()
            experimentTx.radio_driver.radio_off_2_4ghz()
